...
class OldSELD(ScoreFunction):
    ...
    def _compute(self,
        ...
        for file_name in pred_dicts.keys():
            ...
            gt_labels = self.output_format_dict_to_classification_labels(ref_dict, _max_ref_frame)
            pred_labels = self.output_format_dict_to_classification_labels(pred_dict, _max_frame)
    ...
    def output_format_dict_to_classification_labels(self, _output_dict, max_frames):
        ...
        _labels = np.zeros((max_frames + 1, _nb_classes, len(self._azi_list) * len(self._ele_list)))
